...
const initialVideos = [{ id: 1, name: "John" }];
  ...
  useEffect(() => {
    const fetchCourse = async () => {
      try {
        ...
        setThumbnailUrl(courseData.thumbnailUrl); // Set thumbnail URL
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (file) {
                ...
                setThumbnail(file); // Set the thumbnail state here
                uploadImage()
                  .then((url) => {
                    console.log("Thumbnail URL:", url);
                    setError("");
